...
async function getLockedBalances(publicKey) {
    try {
        ...
        try {
            ...
            return processLockedBalances(claimableBalances, publicKey);
        } catch (error) {
            ...
            try {
                ...
                if (response.data && response.data._embedded && response.data._embedded.records) {
                    return processLockedBalances({ records: response.data._embedded.records }, publicKey);
                }
            } catch (httpError) {
...
function processLockedBalances(claimableBalances, publicKey) {
